		...
		<div class="container body">
			<div class="main_container">
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0;">
							<a class="site_title"><i class="fa fa-home"></i> SIAS </a> 
							<p>CAMAT NEGARA</p> 
						</div>
								...
								<ul class="nav side-menu">
									...
									<li><a><i class="fa fa-edit"></i> Transaksi Surat<span class="fa fa-chevron-down"></span></a>
										<ul class="nav child_menu">
											...
											<li><a href="index.php?page=disposisi">Disposisi</a></li>
										</ul>
									</li>
				...
				<footer>
					...
					<strong>© 2020 SIAS CAMAT NEGARA.</strong> All right reserved
					</div>
					<div class="clearfix"></div>
				</footer>
				<!-- /footer content -->
